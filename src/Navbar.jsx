...
const Navbar =() => {
    return(
        ...
        <div className="container-fluid">
            ...
            <NavLink activeClassName="menu-active" className="nav-link navbar-brand"  to="/">H-Tech</NavLink>
            ...
            <li className="nav-item active">
                <NavLink activeClassName="menu-active"className="nav-link" to="/">Home <span class="sr-only">(current)</span></NavLink>
            </li>
